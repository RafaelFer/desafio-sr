...
@Component("calcularAliquotaPJLucroPresumidoService")
public class CalcularAliquotaPJLucroPresumidoService implements AliquotaStrategy {
	...
	public List<ItemNotaFiscal> calcularAlicotaProduto(Pedido pedido) {
		...
		if (valorTotalItens.compareTo(new BigDecimal(999))  != 1) {
			...
			aliquota = BigDecimal.valueOf(0.16);
		} else {
